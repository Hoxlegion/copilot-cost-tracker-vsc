...
[![Version](https://img.shields.io/badge/version-0.6.3-blue.svg)](https://github.com/Hoxlegion/copilot-cost-tracker-vsc/releases)
...
### From VSIX (Manual)
```bash
code --install-extension copilot-cost-tracker-0.6.3.vsix
```
